...
<title>Delete Birthday Party Registration Unsuccessful Page</title>
...
<div class="customer-account-creation-successful-message-window">
    ...
    <p class="window-text">Deletion is Unsuccessful!!!</p>
    
    <a href="Delete Birthday Party Registration Page.jsp" ><button class="home-page-button" >Try Again</button></a>
